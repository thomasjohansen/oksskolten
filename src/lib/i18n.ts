...
const dict = {
  ...
  'openrouter.baseUrl': { ja: 'OpenRouter ベース URL', en: 'OpenRouter Base URL', zh: 'OpenRouter 基础 URL'},
  'openrouter.baseUrlDesc': { ja: 'OpenRouter の API アドレス（通常は変更不要）', en: 'OpenRouter API address (usually no change needed)', zh: 'OpenRouter API 地址（通常无需更改）'},
  'openrouter.baseUrlPlaceholder': { ja: 'https://openrouter.ai/api/v1', en: 'https://openrouter.ai/api/v1', zh: 'https://openrouter.ai/api/v1'},
  'openrouter.baseUrlSaved': { ja: 'OpenRouter の設定を保存しました', en: 'OpenRouter settings saved', zh: 'OpenRouter 设置已保存'},
