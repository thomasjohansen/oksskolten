...
const dict = {
  ...
  'plugins.reprocess.checked': { ja: '{selected}件の記事を確認しました。', en: 'Checked {selected} articles.', de: '{selected} Artikel geprüft.' },
  'plugins.reprocess.moduleCounts': { ja: 'キュー追加 {queued} · スキップ {skipped}', en: 'Queued {queued} · Skipped {skipped}', de: 'Eingereiht {queued} · Übersprungen {skipped}' },
