...
const dict = {
  ...
  'settings.labelCandidates': { ja: 'AIの候補', en: 'AI suggestions', de: 'KI-Vorschläge' },
  'settings.labelCandidatesDesc': { ja: 'AIが提案したラベルです。確認してから使用してください。', en: 'AI suggestions waiting for your review.', de: 'KI-Vorschläge, die auf Ihre Prüfung warten.' },
  'settings.labelCandidateArticles': { ja: '記事 {count}件', en: '{count} articles', de: '{count} Artikel' },
  'settings.labelPromote': { ja: '採用', en: 'Promote', de: 'Übernehmen' },
  'settings.labelMergeTarget': { ja: '統合先ラベル', en: 'Merge target', de: 'Zusammenführen mit' },
  'settings.labelMergeChoose': { ja: '統合先…', en: 'Merge into…', de: 'Zusammenführen mit…' },
  'settings.labelMerge': { ja: '統合', en: 'Merge', de: 'Zusammenführen' },
  'settings.labelDismiss': { ja: '却下', en: 'Dismiss', de: 'Verwerfen' },
  'settings.labelDismissConfirm': { ja: 'このAI候補を却下しますか？候補一覧から削除されます。', en: 'Dismiss this AI suggestion? It will be removed from the review list.', de: 'Diesen KI-Vorschlag verwerfen? Er wird aus der Prüfliste entfernt.' },
  'settings.labelDismissConfirmAction': { ja: '候補を却下', en: 'Dismiss suggestion', de: 'Vorschlag verwerfen' },
  'settings.labelCandidateError': { ja: '処理できませんでした。もう一度お試しください。', en: 'Could not update this suggestion. Try again.', de: 'Vorschlag konnte nicht aktualisiert werden. Bitte erneut versuchen.' },
