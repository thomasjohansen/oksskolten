...
const dict = {
  ...
  'plugins.reprocess.result': { ja: '{selected}件を確認：{queued}件をキューに追加、{skipped}件をスキップしました。', en: 'Checked {selected}: queued {queued}, skipped {skipped}.', de: '{selected} geprüft: {queued} eingereiht, {skipped} übersprungen.' },
