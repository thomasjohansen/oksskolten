...
const dict = {
  ...
  'plugins.relevance.desc': { ja: '読書の軸をひとつ書き留めて、Inboxを自分らしい順番にします。', en: 'Give Inbox one clear reading direction.', de: 'Gib deinem Inbox eine klare Leserichtung.' },
  'plugins.relevance.briefLabel': { ja: '読む内容のメモ', en: 'Reading brief', de: 'Leseprofil' },
  'plugins.relevance.briefHelp': { ja: 'Inboxはこの内容との一致度で記事をスコアリングします。', en: 'Inbox scores articles by how well they match this brief.', de: 'Der Inbox bewertet Artikel danach, wie gut sie zu diesem Profil passen.' },
  'plugins.relevance.placeholder': { ja: '例：科学、都市、日々の暮らしを形づくる人々についての丁寧な報道', en: 'For example: thoughtful reporting on science, cities, and the people shaping everyday life.', de: 'Zum Beispiel: fundierte Berichte über Wissenschaft, Städte und die Menschen, die den Alltag prägen.' },
  ...
  'plugins.relevance.saved': { ja: 'メモを保存しました。新しい記事に適用されます。', en: 'Brief saved. New articles will use it.', de: 'Leseprofil gespeichert. Es gilt für neue Artikel.' },
  'plugins.relevance.error': { ja: 'メモを保存できませんでした。もう一度お試しください。', en: 'Could not save the brief. Try again.', de: 'Leseprofil konnte nicht gespeichert werden. Bitte erneut versuchen.' },
  'plugins.relevance.disabledBrief': { ja: '関連性はオフです。オンにするとメモを編集し、新しい記事をスコアリングできます。', en: 'Relevance is off. Turn it on to edit the brief and score new articles.', de: 'Relevanz ist aus. Aktiviere sie, um das Leseprofil zu bearbeiten und neue Artikel zu bewerten.' },
