...
const dict = {
  ...
  // Settings — AI
  // Labels
  'settings.labels': { ja: 'ラベル', en: 'Labels', zh: '标签' },
  'settings.labelsDesc': { ja: 'キーワードで記事を分類するラベルを作成します', en: 'Create labels to filter articles by keyword', zh: '创建用于按关键词筛选文章的标签' },
  'settings.labelsEmpty': { ja: 'ラベルがありません', en: 'No labels yet', zh: '暂无标签' },
  'settings.labelName': { ja: 'ラベル名', en: 'Label name', zh: '标签名称' },
  'settings.labelMatchText': { ja: 'キーワードまたはフレーズ', en: 'Keyword or phrase', zh: '关键词或短语' },
  'settings.labelMatchFieldTitle': { ja: 'タイトルのみ', en: 'Title only', zh: '仅标题' },
  'settings.labelMatchFieldFullText': { ja: '全文のみ', en: 'Full text only', zh: '仅全文' },
  'settings.labelMatchFieldBoth': { ja: 'タイトルと全文', en: 'Title and full text', zh: '标题和全文' },
  'settings.labelUnreadOnly': { ja: '未読のみ表示', en: 'Show unread only', zh: '仅显示未读' },
  'settings.labelUnreadOnlyOn': { ja: 'オン', en: 'On', zh: '开' },
  'settings.labelUnreadOnlyOff': { ja: 'オフ', en: 'Off', zh: '关' },
  'settings.addLabel': { ja: 'ラベルを追加', en: 'Add label', zh: '添加标签' },
  'settings.editLabel': { ja: 'ラベルを編集', en: 'Edit label', zh: '编辑标签' },
  'settings.labelDeleteConfirm': { ja: '「${name}」を削除しますか？', en: 'Delete label "${name}"?', zh: '确定删除标签“${name}”？' },
  'settings.labelSaveError': { ja: 'ラベルを保存できませんでした', en: 'Could not save label', zh: '无法保存标签' },
  'settings.labelDeleteError': { ja: 'ラベルを削除できませんでした', en: 'Could not delete label', zh: '无法删除标签' },
  'settings.labelDeleteRule': { ja: 'ルールを削除', en: 'Delete rule', zh: '删除规则' },
  'settings.labelAddRule': { ja: 'ルールを追加', en: 'Add rule', zh: '添加规则' },
  'settings.labelRuleTypeOr': { ja: 'OR (いずれかに一致)', en: 'OR (match any)', zh: 'OR（匹配任一）' },
  'settings.labelRuleTypeAnd': { ja: 'AND (必須一致)', en: 'AND (must match)', zh: 'AND（必须匹配）' },
  'settings.labelRuleTypeNot': { ja: 'NOT (除外)', en: 'NOT (exclude)', zh: 'NOT（排除）' },
  'settings.labelExclusive': { ja: '排他的マッチ', en: 'Exclusive match', zh: '排他匹配' },
  'settings.labelExclusiveDesc': { ja: '一致した記事を優先度の低いラベルから除外します', en: 'Hide matched articles from lower-priority labels', zh: '从优先级较低的标签中隐藏匹配的文章' },
  'feeds.labels': { ja: 'ラベル', en: 'Labels', zh: '标签' },
